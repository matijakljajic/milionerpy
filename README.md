...
The project was at first based on the Serbian TV quiz called "Slagalica" and its game "Ko zna zna" but during development, some altercations did occur and it couldn't be submitted for grading unfortunately. That project can be found at this [link](https://github.com/matijakljajic/koznaznarevamp).

*If you want to read the official paper behind this work, you can do so over this [link](). If you want the official Serbian version of the paper, it is available over this [link]().*
